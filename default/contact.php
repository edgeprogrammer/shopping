...
<head>
        ...
        <title>Client Bazar - Contact Us</title>
...
<!--                             <ul class="contact-list">
                                <li><i class='bx bx-map'></i> Location: <a href="#">2 , Central Lane,Bangali Market,Mandi House,Cannaught Place,New Delhi-110001.</a></li>
                                <li><i class='bx bx-phone-call'></i> Call Us: <a href="tel:+01321654214">+01 321 654 214</a></li>
                                <li><i class='bx bx-envelope'></i> Email Us: <a href="mailto:info@clientinvestors.com">info@clientinvestors.com</a></li>
                        ...
                        <div class="contact-form">
                            ...
                            <form id="contactForm">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <button type="submit" class="default-btn" onclick="window.location.href='email.php';">Send Message</button>
