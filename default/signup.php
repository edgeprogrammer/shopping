...
<head>
        ...
        <title>Client Investors - Sign Up</title>
                ...
                <div class="signup-content">
                    ...
                    <form class="signup-form" method="post" action="registration.php">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter your name" id="fname" name="firstName">
                        </div>
                         <div class="form-group">
                            <label>Contact Number</label>
                            <input type="tel" class="form-control" placeholder="Enter your mobile number" id="name" name="number">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <label>Address</label>
                            <textarea name="address" class="form-control" placeholder="Enter your address" id="uaddress" ></textarea>
                        </div>
