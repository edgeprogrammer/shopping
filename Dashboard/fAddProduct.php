          ...
          <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="fdisp.php.php">Fashion Products</a>
              ...
              <div class="">
                <form class="form" action="#" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input type="text" name="fcat" class="form-control" placeholder="Fashion Category" required>
                  </div>
                  <div class="form-group">
                    <label for="fsubcat">Sub Category</label>
                    <input type="text" name="fsubcat" class="form-control" placeholder="Fashion Sub Category" required>
                  </div>
                  <div class="form-group">
                    <label for="ftype">Type </label>
                    <input type="text" name="ftype" class="form-control" placeholder="Fashion Type" required>
                  </div>
                  <div class="form-group">
                    <label for="fbrand">Brand </label>
                    <input type="text" name="fbrand" class="form-control" placeholder="Brand Name" required>
                  </div>
                  <div class="form-group">
                    <label for="fsize">Size </label>
                    <input type="text" name="fsize" class="form-control" placeholder="Size: M / L / XL / XXL / XXXL" required>
                  </div>
                  <div class="form-group">
                    <label for="fprice">Price </label>
                    <input type="text" name="fprice" class="form-control" placeholder="Product Price" required>
                  </div>
                  <div class="form-group">
                    <label for="fdesc">Product Description </label>
                    <textarea name="fdesc" class="form-control" rows="5" cols="80" placeholder="About Your Product: Few Lines for attract customers"></textarea>
                    <!-- <input type="text" name="gprice" class="form-control" placeholder="Product Price" required> -->
                  </div>

                  <div class="form-group">
                    <label for="fimg1">Product 1st Image</label>
                    <input type="file" name="fimg1" accept=".jpg, .png" required />
                  ...
                  <div class="form-group">
                    <label for="fimg2">Product 2nd Image</label>
                    <input type="file" name="fimg2" accept=".jpg, .png" required />
                      <!-- <div class="custom-file">
                       <input type="file" class="custom-file-input" name="uReport" id="validatedCustomFile" accept=".pdf" >
                       <label class="custom-file-label" for="validatedCustomFile">Choose Report...</label>
                     </div> -->
                  ...
                  <div class="form-group">
                    <label for="fimg3">Product 3rd Image</label>
                    <input type="file" name="fimg3" accept=".jpg, .png" required />
                      <!-- <div class="custom-file">
                       <input type="file" class="custom-file-input" name="uReport" id="validatedCustomFile" accept=".pdf" >
                       <label class="custom-file-label" for="validatedCustomFile">Choose Report...</label>
                     </div> -->
...
<?PHP
  if(isset($_POST['submit']))
  {
    ...
    // product id stratgy
    $id = "F".date("m").strtoupper($type[0]).date("yhi");

    // binary format image conversion
    $image1 = addslashes($_FILES['fimg1']['tmp_name']);
    $name1 = addslashes($_FILES['fimg1']['tmp_name']);
    $image1 = file_get_contents($image1);
    $image1 = base64_encode($image1);

    $image2 = addslashes($_FILES['fimg2']['tmp_name']);
    $name2 = addslashes($_FILES['fimg2']['tmp_name']);
    $image2 = file_get_contents($image2);
    $image2 = base64_encode($image2);

    $image3 = addslashes($_FILES['fimg3']['tmp_name']);
    $name3 = addslashes($_FILES['fimg3']['tmp_name']);
    $image3 = file_get_contents($image3);
    $image3 = base64_encode($image3);

    // database record insert query

    $sql = "INSERT INTO `fproduct`(`fid`, `fcat`, `fsubCat`, `ftype`, `fbrand`, `fsize`, `fprice`, `fdesc`, `fimg1`, `fimg2`, `fimg3`) VALUES ('$id','$cat','$scat','$type','$brand','$size','$price','$desc','$image1','$image2','$image3') ";
    // echo $sql;
