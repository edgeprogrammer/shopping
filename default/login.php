...
<head>
        ...
        <title>Client Bazar - Login</title>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="login-content">
                            ...
                            <form class="login-form" action="success.php" method="post">
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="Username or email address" name="email">
                                </div>
