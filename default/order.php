...
<head>
        ...
        <title>Client Investors -  Order</title>
                ...
                <div class="signup-content">
                    ...
                    <form class="signup-form" action="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" placeholder="Enter your Number" id="password" name="number">
                        </div>
                        <div class="form-group">
                            <label>Products</label>
                            <textarea class="form-control" placeholder="Enter your Products" id="password" name="products"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <textarea class="form-control" placeholder="Enter your Address" id="password" name="address"></textarea>
                        </div>



                        <button type="submit" class="default-btn"  ><a href="mail.php">Place Order</a></button>
