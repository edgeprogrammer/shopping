                    ...
                    <div class="d-table-cell">
                        <div class="container">
                            <div class="main-banner-content text-center">
                              ...
                              <div class="btn-box">
                                  <a href="product.php?id=Women" class="default-btn">Shop Women's</a>
                                  <a href="product.php?id=Men" class="optional-btn">Shop Men's</a>
                              </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="main-banner banner-bg3">
                <div class="d-table">
                    <div class="d-table-cell">
                        <div class="container">
                            <div class="main-banner-content">
                                <span class="sub-title">Buy Now From Client Investers!</span>
                                <h1>Safety products</h1>
                                <p>.....................</p>
                                <div class="btn-box">
                                    <a href="product.php?id=Masks" class="default-btn">Face Mask</a>
                                    <a href="product.php?id=Senetiser" class="optional-btn">Hand Senetiser</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-categories-box">
                            <img src="assets/img/categories/daal.jpg" alt="image" style="height: 200px;">

                            <div class="content text-white">
                                <span style="color: black;">Don’t Hi Miss Today</span>
                                <h3 style="color: black;">50% OFF</h3>
                                <a href="product.php?id=G1" class="default-btn">Discover Now</a>
                            </div>
                            <a href="product.php?id=G1" class="link-btn"></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-categories-box">
                            ...
                            <div class="content">
                                ...
                                <h3>Need Now</h3>
                                <a href="product.php?id=Men" class="default-btn">Discover Now</a>
                            </div>
                            <a href="product.php?id=Men" class="link-btn"></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-categories-box">
                            ...
                            <div class="content">
                                ...
                                <h3>Must Haves</h3>
                                <a href="product.php?id=Women" class="default-btn">Discover Now</a>
                            </div>
                            <a href="product.php?id=Women" class="link-btn"></a>
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-categories-box">
                            <img src="assets/img/categories/client2.jpg" alt="image" style="height: 200px;">

                            <div class="content text-white">
                                <span style="color: black;">Take 20% OFF</span>
                                <h3 style="color: black;">Senetiser!</h3>
                                <a href="product.php?id=Senetiser" class="default-btn">Discover Now</a>
                            </div>
                            <a href="product.php?id=Senetiser" class="link-btn"></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    while ($row = mysqli_fetch_assoc($result) )
                    {
                      ...
                      if($i<6)
                      {
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                          <div class="single-products-box" id="Grocery">
                            ...
                            <div class="products-content">
                                <h3><a href="#"> <?PHP echo $row['gtype']; echo "&nbsp;(".$row['gbrand'].")"; ?></a></h3>
                                <!-- <div class="price">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <div class="offer-content">
                            ...
                            <a href="products-one-row.php" class="default-btn">Discover Now</a>
                        </div>
                    </div>
                </div>
            </div>
                  ...
                  if(mysqli_num_rows($result)>0)
                  {
                    ...
                    while ($row = mysqli_fetch_assoc($result) )
                    {
                      if($i<3)
                      {
                        ?>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                          <div class="single-products-box" id="Fashion" >
                            <div class="products-image">
                                <a href="#">
                            ...
                            <div class="products-content">
                                <h3><a href="#"><?PHP echo $row['fsubCat'].'-'.$row['ftype'].'('.$row['fbrand'].')' ; ?></a></h3>
                                <!-- <div class="price">
                                    <span class="old-price">$321</span>
                                    <span class="new-price">$250</span>
                                </div> -->
                  ...
                  if(mysqli_num_rows($result)>0)
                  {
                    ...
                    while ($row = mysqli_fetch_assoc($result) )
                    {
                      if($i<3)
                      {
                        ?>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="single-products-box" id="Safety" >
                                ...
                                <div class="products-content">
                                    <h3><a href="#"><?PHP echo $row['sbrand'].'('.$row['squantity'].')' ; ?></a></h3>
                                    <div class="price">
